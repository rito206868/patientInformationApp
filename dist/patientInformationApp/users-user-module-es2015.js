...
/* harmony import */ var src_app_shared_message_box__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/message-box */ "./src/app/shared/message-box.ts");
    ...
    login(loginFormValue) {
        if (this.loginForm.valid) {
            if (loginFormValue.username === "admin" && loginFormValue.password === "admin") {
                src_app_shared_message_box__WEBPACK_IMPORTED_MODULE_7__["MessageBox"].show(this.dialog, "Alert", 'Login Successfully', src_app_shared_message_box__WEBPACK_IMPORTED_MODULE_7__["MessageBoxButton"].Ok, "350px")
                    .subscribe(result => {
                ...
                src_app_shared_message_box__WEBPACK_IMPORTED_MODULE_7__["MessageBox"].show(this.dialog, "Error", 'Invalid User Name or Password', src_app_shared_message_box__WEBPACK_IMPORTED_MODULE_7__["MessageBoxButton"].Ok, "350px");
        }
    }
};
...
/* harmony import */ var _user_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user-routing.module */ "./src/app/users/user-routing.module.ts");
...
//# sourceMappingURL=users-user-module-es2015.js.map